  ...
  return (
    <section className="relative w-full min-h-screen bg-[#E9E9E7] font-sans overflow-x-hidden">
      ...
      <motion.div
        ...
        whileInView="visible"
        viewport={{ once: true }}
        className="relative flex w-full min-h-[350px] sm:min-h-[450px] bg-[#1a1612] shadow-2xl overflow-hidden"
      >
        ...
        <div className="relative flex-1 flex flex-col justify-between p-5 sm:p-8 md:p-16">
          ...
          <div className="relative mt-10 sm:mt-16 md:mt-20 h-48 sm:h-64">
            ...
            <motion.div
              ...
              className="hidden sm:flex absolute bottom-[-20px] left-64 md:left-80 z-10 h-36 sm:h-40 w-52 sm:w-64 flex-col justify-center rounded-3xl bg-[#004643] p-5 sm:p-8 text-white shadow-xl"
            >
