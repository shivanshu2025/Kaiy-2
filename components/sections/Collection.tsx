...
export default function PortfolioPage() {
  return (
    <main className="relative min-h-screen bg-[#E9E9E7] text-[#1F2A1F] font-sans selection:bg-[#004643] selection:text-white overflow-hidden">
      ...
      {/* Hero Section */}
      <section className="relative p-4 sm:p-8 md:p-12 lg:p-16 flex items-center justify-center min-h-screen z-10">
        <div className="max-w-6xl w-full grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-12 lg:gap-16 items-center">
          ...
          <div className="relative">
            ...
            <motion.div
              ...
              className="relative bg-[#004643] p-6 sm:p-10 md:p-12 rounded-[2.5rem] sm:rounded-[3.5rem] aspect-square overflow-hidden shadow-[0_50px_100px_-20px_rgba(0,70,67,0.3)] flex flex-col justify-between"
            >
