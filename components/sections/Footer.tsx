        ...
        <div>
          ...
          <div className="flex w-full max-w-sm flex-col overflow-hidden rounded-full border border-gray-400 sm:flex-row sm:items-center">
            <input
              ...
              className="min-w-0 flex-1 bg-transparent px-4 py-2.5 sm:py-3 text-sm outline-none"
            />
            <button className="rounded-full bg-[#2f4f3f] px-5 sm:px-6 py-2.5 sm:py-3 text-sm font-semibold text-white transition hover:bg-[#666660]">
              Subscribe
            </button>
          </div>
        </div>
