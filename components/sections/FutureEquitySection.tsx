  ...
  return (
    <section className="bg-[#E9E9E7] px-4 py-12 sm:px-6 sm:py-16 md:px-12 md:py-20 lg:px-24 lg:py-20 text-[#1a1612] relative overflow-hidden">
      ...
      <div className="mt-10 sm:mt-16 md:mt-20 grid grid-cols-1 gap-10 md:grid-cols-2 relative">
        ...
        {/* Right Image */}
        <div className="relative flex items-center justify-center md:justify-end min-h-[200px] md:min-h-[300px]">
          <img
            src="https://www.ventivegroup.com/wp-content/uploads/2025/02/business-development-startup.png"
            alt="Equity Illustration"
            className="w-full max-w-xs sm:max-w-sm md:max-w-none md:absolute md:top-0 md:right-0 md:bottom-0 md:h-full md:w-auto object-contain"
          />
        </div>
